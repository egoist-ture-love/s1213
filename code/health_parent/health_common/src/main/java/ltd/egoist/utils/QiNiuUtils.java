...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "POcjoiyxF-v3-s0258ran5sKMo_VmvctUWD1e8PF";
    private static final String SECRETKEY = "r9dSW1cV7CqByqNXyyriN1OFcumY75JFujMS4Qg9";
    private static final String BUCKET = "egoist01";
    public static final String DOMAIN= "http://qtlawvmxg.hb-bkt.clouddn.com/";
