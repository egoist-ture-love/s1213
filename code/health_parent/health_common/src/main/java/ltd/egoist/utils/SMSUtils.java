...
public class SMSUtils {
	...
	private static final String ACCESS_KEY="LTAI4G5HFZ63SxN9vVX1P4pA"; //你的AccessKey ID
	private static final String SECRET_KEY="Y11dJpneXTzjWSU3OpORzwJsv1ppAJ"; //你的AccessKey Secret
